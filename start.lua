...
print("::Black::")
local RunBot = io.open("MeTro", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/MeTro
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr MeTro.lua
wget "https://raw.githubusercontent.com/LARICATEAM/MeTro/master/MeTro.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./MeTro.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S MeTro -X kill
screen -S MeTro ./MeTro
done
]])
RunTs:close()
end
