...
if text == (database:get(bot_id.."MeTro:Name:Bot") or "كراند") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."MeTro:Name:Bot") or "كراند")
local namebot = {
...
if DevMeTro(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceMeTro/files_MeTro/master/getfile.json")
if res == 200 then
...
[⌔︙ MeTro Developer .](http://t.me/IIlppp)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
local Name_Bot = (database:get(bot_id.."MeTro:Name:Bot") or "كراند")
